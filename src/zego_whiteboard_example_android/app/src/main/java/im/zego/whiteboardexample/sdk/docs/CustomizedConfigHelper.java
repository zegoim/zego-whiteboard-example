...
public class CustomizedConfigHelper {
    ...
    public static void loadVideoInPPT(boolean load){
        Log.d(TAG, "loadVideoInPPT() called with: load = [" + load + "]");
        ZegoDocsViewManager.getInstance().setCustomizedConfig("unloadVideoSrc",String.valueOf(!load));
    }
}
